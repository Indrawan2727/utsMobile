package id.wain.catatan.activity._main
...
import id.wain.catatan.activity._main.adapter.MenuAdapter
import id.wain.catatan.activity._main.presenter.MainPresenter
import id.wain.catatan.activity._main.presenter.MainView
import id.wain.catatan.activity.data_barang.DataBarangActivity
import id.wain.catatan.activity.login.LoginActivity
import id.wain.catatan.activity.penjualan.PenjualanBarang
import id.wain.catatan.activity.report.ReportActivity
import id.wain.catatan.base.BaseActivity
import id.wain.catatan.model.Keranjang
import id.wain.catatan.utils.Uang
