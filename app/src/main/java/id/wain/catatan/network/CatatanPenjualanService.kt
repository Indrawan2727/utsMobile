package id.wain.catatan.network

import id.wain.catatan.activity.data_barang.data.ResultDataBarang
import id.wain.catatan.activity.login.data.ResultLogin
import id.wain.catatan.activity.penjualan.data.ResultKeranjang
import id.wain.catatan.activity.penjualan.data.ResultSearchBarang
import id.wain.catatan.activity.report.detail.data.ResultItemKeranjang
import id.wain.catatan.response.ResultSimple
